...
log_types = [u'virtual', u'auto_session_ban', u'auto_post_invisible',
             u'user_post_delete', u'op_post_delete', u'user_thread_delete',
             u'mod_post_delete', u'mod_post_invisible', u'mod_thread_delete',
             u'mod_post_revive', u'mod_session_action',
             u'mod_restriction_action', u'mod_login', u'mod_view_post',
             u'mod_view_session', u'mod_file_edit', u'mod_post_edit']
...
class BaseEventLog(meta.Declarative):
    ...
    __mapper_args__ = {'polymorphic_on': type,
                       'polymorphic_identity': u'virtual'}
...
class AutoPostInvisible(BaseEventLog):
    ...
    def get_message(self):
        return u"Post {0.post_id} was auto-invised due to {0.reason}.".format(
            self)
...
class ModPostDeleteLog(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} deleted post {0.post_id} for {0.reason}".format(
            self)
...
class ModThreadDeleteLog(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} deleted thread {0.post_id} for {0.reason}".format(
            self)
...
class ModPostInvisibleLog(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} made post {0.post_id} {0.action}".format(
            self)
...
class ModSessionActionLog(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} {0.action} <a href='{1}'>session</a>.".format(
            self, url('session', session_id=self.target_session_id))
...
class ModRestrictionActionLog(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} {0.action} restriction {0.restriction_id}".format(
            self)
...
class ModViewSession(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} viewed <a href='{1}'>session</a>.".format(
            self, url('session', session_id=self.target_session_id))
...
class ModEditFile(BaseEventLog):
    ...
    def get_message(self):
        return u"Admin {0.admin.login} edited <a href='{1}'>file</a>.".format(
            self, url('files_id', file_id=self.file_id))
...
__all__ = ['ModEditFile', 'ModEditPost', 'ModLogin', 'ModPostDeleteLog',
           'ModPostInvisibleLog', 'ModRestrictionActionLog', 'ModRevivePost',
           'ModSessionActionLog', 'ModThreadDeleteLog', 'ModViewPost',
           'ModViewSession', 'UserPostDeleteLog', 'UserThreadDeleteLog',
           'OPPostDeleteLog', 'AutoSessionBan', 'AutoPostInvisible', 'IP',
           'BaseEventLog']
