...
class FontsManager(object):
    ...
    fonts = {
        ...
        "vlgothic": {'name': 'VL Gothic',
                     ...
                     'subsets': [],
                     'style': 'normal'},
        "palatino": {'name': 'URW Palladio L',
                     'path':
                     '@/usr/share/fonts/default/ghostscript/p052003l.pfb',
                     'width': 0.5,
                     'mono': False,
                     'subsets': [],
                     'style': 'normal'},
        "vera": {'name': 'Bitstream Vera Sans',
                 'path': '@/usr/share/fonts/ttf-bitstream-vera/Vera.ttf',
                 'width': 0.5,
                 'mono': False,
                 'subsets': [],
                 'style': 'normal'},
        ...
        "verdana": {'name': 'Verdana',
                    'path': '@/usr/share/fonts/corefonts/verdana.ttf',
                    'width': 0.5,
                    'mono': False,
                    'subsets': [],
                    'style': 'normal'},
        ...
        "times new roman": {'name': 'Times New Roman',
                            'path': '@/usr/share/fonts/corefonts/times.ttf',
                            'width': 0.5,
                            'mono': False,
                            'subsets': [],
                            'style': 'normal'},
        "freeserif": {'name': 'FreeSerif',
                      'path': '@/usr/share/fonts/freefont-ttf/FreeSerif.ttf',
                      'width': 0.5,
                      'mono': False,
                      'subsets': [],
                      'style': 'normal'},
