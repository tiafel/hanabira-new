...
def gen_load_environment(cfile, pkgname, app_globals, helpers_lib, make_map,
                         init_model):
    def load_environment(global_conf, app_conf, setup_mode=False):
        ...
        config['pylons.strict_tmpl_context'] = config.get(
            'pylons.strict_tmpl_context', 'true') == 'true'
...
load_environment = gen_load_environment(__file__, 'hanabira', app_globals,
                                        helpers_lib, make_map, init_model)
